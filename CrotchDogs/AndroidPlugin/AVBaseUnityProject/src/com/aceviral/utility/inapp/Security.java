...
public class Security
{
			...
			String signature)
	{
		...
		AVUtility.DebugOut(TAG, "signedData: " + signedData);
	...
	public static boolean verify(PublicKey publicKey, String signedData,
			String signature)
	{
		AVUtility.DebugOut(TAG, "signature: " + signature);
		Signature sig;
		try
		{
