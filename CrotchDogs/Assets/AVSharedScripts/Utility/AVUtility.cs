...
public class AVUtility : MonoBehaviour {
    ...
    public static bool IsIOSDeviceGash() {
#if UNITY_IPHONE
    ...
    public static bool IsIOSDeviceIPad() {
		...
		if(iPhone.generation == iPhoneGeneration.iPad1Gen || iPhone.generation == iPhoneGeneration.iPad2Gen || iPhone.generation == iPhoneGeneration.iPad3Gen ||
			iPhone.generation == iPhoneGeneration.iPad4Gen || iPhone.generation == iPhoneGeneration.iPadMini1Gen || iPhone.generation == iPhoneGeneration.iPadUnknown){
			return true;
		}
#endif
        return false;
    ...
    private static float m_CurrentDPI = DeviceProfiles.GetDeviceDPI();
    public static float TouchInputModifier {
        get {
            if (m_CurrentDPI == 0.0f) return 1.0f;
            return TARGET_DPI / m_CurrentDPI;
        }
    }
